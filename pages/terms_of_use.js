export default function terms_of_use() {
  return (
    <div className="my-20 w-3/4 mx-auto">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to next-tailwind-mongo-next-auth-boilerplate.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            ...
            next-tailwind-mongo-next-auth-boilerplate, accessible from{" "}
            <a
              href="https://next-tailwind-mongo-next-auth-boilerplate.vercel.app/"
              target="_blank"
              rel="noopener noreferrer"
            >
              https://next-tailwind-mongo-next-auth-boilerplate.vercel.app/
            </a>
          </p>
        </li>
        <li>
      ...
      <ul>
        <li>By email: mutumasir@gmail.com</li>
      </ul>
    </div>
  );
}
